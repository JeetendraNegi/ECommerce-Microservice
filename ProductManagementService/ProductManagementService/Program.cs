...
builder.Services.AddScoped<IDataAccessService<SallersDetail>, SallerDataAccessService>();
builder.Services.AddScoped<IProductDataAccessService<ProductDetail>, ProductDataAccessService>();
